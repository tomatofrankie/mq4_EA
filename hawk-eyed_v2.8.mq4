...
void CheckStochCross(){
   ...
   double macd=iMACD(Symbol(),0,12,16,9,PRICE_CLOSE,MODE_MAIN,1);
   ...
   double tmp1=iMA(Symbol(),0,13,0,MODE_SMA,0,1);
   double tmp2=iMA(Symbol(),0,13,0,MODE_LWMA,0,1);
   double linreg_curr=3.0*tmp2-2.0*tmp1;
   
   tmp1=iMA(Symbol(),0,13,0,MODE_SMA,0,2);
   tmp2=iMA(Symbol(),0,13,0,MODE_LWMA,0,2);
   double linreg_pre=3.0*tmp2-2.0*tmp1;

   //double adx_adx_line=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MAIN,0);
   //double adx_plus_DI_2=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_PLUSDI,2);
   //double adx_minus_DI_2=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MINUSDI,2);
   //double adx_plus_DI_1=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_PLUSDI,1);
   //double adx_minus_DI_1=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MINUSDI,1);
   //double adx_plus_DI_0=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_PLUSDI,0);
   //double adx_minus_DI_0=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MINUSDI,1);
   //double adx_plus_DI_3=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_PLUSDI,3);
   //double adx_minus_DI_3=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MINUSDI,3);
   //double adx_plus_DI_4=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_PLUSDI,4);
   //double adx_minus_DI_4=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MINUSDI,4);
   //double adx_plus_DI_5=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_PLUSDI,5);
   //double adx_minus_DI_5=iADX(Symbol(),0,14,PRICE_CLOSE,MODE_MINUSDI,5);
   //double atr=iATR(Symbol(),0,13,1);
   //double ema_of_atr=iMA(atr,0,13,0,MODE_EMA,0,1);

   if (curr_adx>30 &&
   macd>0 &&
   curr_adx>pre_adx &&
   linreg_curr>linreg_pre
   ) {
